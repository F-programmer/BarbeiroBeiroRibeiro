      ...
      <div id="cadastro">
        <form action="cadastrar-cliente.php" method="POST" id="cadastro_form">
          ...
          <fieldset>
            ...
            <input type="Numero" id="txtCpfCliente" name="txtCpfCliente" placeholder="Digite seu CPF" required
              maxlength="14">
          </fieldset>

          <fieldset>
            <label for="txtNome">Email: </label>
            <input type="email" id="txtEmailCliente" name="txtEmailCliente" placeholder="exemplo@gmail.com" required
              maxlength="40">
          </fieldset>

          <fieldset>
            <label for="txtNumeroContato">Número para contato: </label>
            <input type="text" id="txtFoneCliente" name="txtFoneCliente" placeholder="Exemplo: (11) 91234-5678" required
              maxlength="15">
          </fieldset>
