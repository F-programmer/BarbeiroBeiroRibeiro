			...
			<div id="cadastro">
				<form action="./cadastrar-imagen.php" method="POST" enctype="multipart/form-data" id="cadastro_form">
					...
					<fieldset>
						...
						<input type="text" id="txtDescricaoImagen" name="txtDescricaoImagen" placeholder="Ex: Foto de serviço realizado." required>
					</fieldset>
					...
					<fieldset class="file">
						...
						<div class="area-upload">
							...
							<input type="file" accept="image/jpg,image/png,image/jpeg,image/bitmap" id="upload-file" name="inputFile" required />
						</div>
					</fieldset>
